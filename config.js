...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/bfc18d0c0d647e5660716.jpg";
...
module.exports = {
  ...
  author: process.env.STICKER_AUTHOR || "yesser teach",
  packname: process.env.STICKER_NAME || "yesserboy",
  botname: process.env.BOT_NAME || "𝘽𝙇𝘼𝘾𝙆-𝙋𝘼𝙉𝙏𝙃𝙀𝙍-𝙈𝘿",
  ownername: process.env.OWNER_NAME || "yesser boy",
  errorChat: process.env.ERROR_CHAT || "im yessemd",
